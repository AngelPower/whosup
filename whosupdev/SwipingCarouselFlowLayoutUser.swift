...
public class SwipingCarouselFlowLayoutUser:  UICollectionViewFlowLayout {
    
    // Mark: Constants 
    fileprivate struct Constants {
        static let zoomFactor: CGFloat = 0
        static let itemWidth: CGFloat = 363       //Width of the Cell.
        static let itemHeight: CGFloat = 252      //Height of the Cell.
